...
class AgentEventType(str, Enum):
    ...
    Tool lifecycle:
        ...
        TOOL_ARG_DELTA        - streaming JSON arg patch
    ...
    Domain (optional payload extension layer):
        ...
        EVIDENCE_LINKED            - Action Graph evidence link created
    ...
    # Runtime substrate / session lifecycle
...
class AgentEvent:
    ...
    docs/architecture/V3_EVENTS.md.
    """
