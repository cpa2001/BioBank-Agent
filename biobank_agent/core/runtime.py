...
class AsyncAgent:
    ...
    async def stream_events(self, query: str) -> AsyncIterator[AgentEvent]:
        ...
        for round_n in range(max_rounds):
            ...
            # preserve legacy ordering; M2 will introduce parallel
            # scheduling for independent calls.
            for tc in response.tool_calls:
    ...
    async def _dispatch_tool_call(
        ...
        *,
        ...
        # Reproducibility hook (M1.9): full checkpoint with data
        ...
        # Auto-link the result into Evidence Lattice when relevant.
        ev_id = None
        try:
