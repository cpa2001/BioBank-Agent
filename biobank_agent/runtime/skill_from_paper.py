...
statistical/omics sin BEFORE any code is generated (the methodology pre-gate) -> build an
...
def synthesize_skill_from_paper(
    ...
    *,
    ...
    # METHODOLOGY PRE-GATE: a consensus statistical/omics sin in the declared method rejects it BEFORE any code
