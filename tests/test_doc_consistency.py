"""Lightweight consistency self-check — docs/pyproject vs the live registries.

Guards against the skill/command counts and the version string drifting out of sync
(the exact drift this guards against). Deterministic and offline: it reads the same registries
